...
for rodada in range(rodadas):
    print(f'Iniciando processamento da rodada {rodada+1}...')
    if Path(f'./datasets/tratados/2024.{rodada+1}.json').exists():
        with open(f'./datasets/tratados/2024.{rodada+1}.json', 'r', encoding='utf-8') as file:
                ...
                for alteracao in jogo['mandante']['alteracoes']:
                    cur.execute(f"""
                                ...
                                (
                                    ...
                                    '0001-01-01 00:{alteracao['tempo_jogo']}', 
                                    '{alteracao['tempo_subs']}', 
                                    '0001-01-01 00:{alteracao['tempo_acrescimo']}', 
                                    {jogo['id_jogo']},
                                    {jogo['visitante']['id']}
                                );
                                """)
        ...
        print(f'Processamento da rodada {rodada+1} finalizado.')